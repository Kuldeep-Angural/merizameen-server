export const callBackTemplate = ({sellerName , userName , email , mobile ,  propertyTitle}) => {
    return(`
  ...
  <div style="max-width: 600px; margin: 20px auto; padding: 20px; background-color: #fff; border-radius: 12px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <div style="margin-bottom: 20px;">
      ...
      <p>
         You received an call back request <br/>
        regarding this property ${propertyTitle}
        <br/>
        Please response as soon as possible.
      </p>
      <p>
        <div> Requested by : <b>${userName }</b> , email : <b>${email} </b>, mobile : <b>${mobile}</b> </div>
